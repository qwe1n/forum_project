...
<body>
  <div class="container">
    <div class="row clearfix">
      <div class="col-md-12 column" style="height: 100px;width:100%;">
        <img alt="背景图" src="image/R.jpg" id = "backimg">
      </div>
    </div>
    <div class="row clearfix">
      ...
      <div class="col-md-1 column">
        <button type="button" class="btn btn-default btn-danger btn-block">注销</button>
      </div>
    </div>
  </div>